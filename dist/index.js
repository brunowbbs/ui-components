...
var showAlert = ({
  ...
  let toastId = null;
  const CustomToast = () => /* @__PURE__ */ jsx("div", { className: "px-2", children: /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx(
      "p",
      {
    ...
    /* @__PURE__ */ jsx("p", { className: "text-sm", style: { fontFamily: "Plus Jakarta Sans" }, children: message }),
    textButton && /* @__PURE__ */ jsx(
      "button",
      {
        onClick: () => {
          if (onAction)
  ...
  toastId = toast(/* @__PURE__ */ jsx(CustomToast, {}), {
    autoClose: false,
...
function Button(props) {
  ...
  return /* @__PURE__ */ jsx3(
    "button",
    {
      ...
      children: isLoading ? /* @__PURE__ */ jsx3("span", { children: /* @__PURE__ */ jsx3(Spinner, { color: outline ? "green" : "white" }) }) : /* @__PURE__ */ jsx3(
        "p",
        {
          className: clsx2({
            "text-primary hover:text-primary-darker hover:transition font-medium": link
          }),
          children: /* @__PURE__ */ jsxs3("span", { className: "flex flex-row items-center gap-1 text-sm", children: [
            iconLeft && /* @__PURE__ */ jsxs3("span", { children: [
              " ",
              iconLeft
            ] }),
            text && /* @__PURE__ */ jsxs3("span", { children: [
              " ",
              text
            ] }),
            iconRight && /* @__PURE__ */ jsxs3("span", { children: [
              " ",
              iconRight
            ] })
          ] })
...
import { useForwardedRef as useForwardedRef3 } from "@bedrock-layout/use-forwarded-ref";
import { useButton } from "react-aria";
import { useSlots as useSlots2 } from "use-slots";

// lib/components/iconText/index.tsx
import { Children, forwardRef as forwardRef3 } from "react";
import useForwardedRef2 from "@bedrock-layout/use-forwarded-ref";
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, $73SJx$react)["useSyncExternalStore"] === "function")
    return (0, $73SJx$react)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
  return (0, $73SJx$useContext)($b5e257d569688ac6$var$IsSSRContext);
}

// node_modules/@react-aria/utils/dist/import.mjs
import $12uGp$clsx from "clsx";
var $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c = typeof document !== "undefined" ? (0, $12uGp$react).useLayoutEffect : () => {
};
...
var IconText = forwardRef3(
  ({ children, isVertical = false, as, size }, ref) => {
    const forwardedRef = useForwardedRef2(ref);
...
var IconLeft = beSlot(
  (props) => /* @__PURE__ */ jsx6(Icon, { ...props }),
  "leftIcon"
);
var IconRight = beSlot(
  (props) => /* @__PURE__ */ jsx6(Icon, { ...props }),
  "rightIcon"
);
...
var ButtonV2 = forwardRef4(
  (props, ref) => {
    ...
    const forwardedRef = useForwardedRef3(ref);
    const normalButton = useButton(props, forwardedRef);
    const { firstIcon, lastIcon } = useSlots2(children);
    const Tag = isSummary ? "summary" : "button";
    const onlyOne = Children2.count(children) === 1;
    ...
    return /* @__PURE__ */ jsx7(
      Tag,
      {
        ...
        disabled: isDisabled,
        ...buttonProps,
        children: /* @__PURE__ */ jsx7(IconText, { isVertical, children: isLoading ? /* @__PURE__ */ jsx7("div", { className: "mt-auto mb-auto min-w-24 flex items-center justify-center", children: /* @__PURE__ */ jsx7(Spinner, { color: isOutlined ? "green" : "white" }) }) : children })
      }
    );
  }
);
...
function Card({ children }) {
  return /* @__PURE__ */ jsx8("div", { className: "card", children });
}
...
function BarChart({
  ...
  if (sourceData?.length < 1) {
    return /* @__PURE__ */ jsx9("h3", { className: "text-sm ", children: "Informe os dados do Bar chart" });
  }
  return (
    // <Card>
    /* @__PURE__ */ jsx9("div", { className: "flex-1", style: { height }, children: /* @__PURE__ */ jsx9(
      Bar,
      {
        data: {
...
import { defaults as defaults2 } from "chart.js/auto";
import { Doughnut } from "react-chartjs-2";
import { jsx as jsx10 } from "react/jsx-runtime";
defaults2.maintainAspectRatio = false;
defaults2.responsive = true;
defaults2.plugins.title.display = true;
defaults2.plugins.title.align = "start";
defaults2.plugins.title.color = "black";
var sourcedata = [
  {
    label: "Marcela",
    value: 32
...
function DougnutChart({
  ...
  return /* @__PURE__ */ jsx10("div", { className: "w-full", style: { height }, children: /* @__PURE__ */ jsx10(
    Doughnut,
    {
      data: {
        labels: sourceData.map((data) => data.label),
...
import { defaults as defaults3 } from "chart.js/auto";
import { Line } from "react-chartjs-2";
import { jsx as jsx11 } from "react/jsx-runtime";
defaults3.maintainAspectRatio = false;
defaults3.responsive = true;
defaults3.plugins.title.display = false;
defaults3.plugins.title.align = "start";
defaults3.plugins.title.color = "black";
function LineChart({
  height = 400,
  sourceData = [],
  offset = 4,
  ...
  return /* @__PURE__ */ jsx11("div", { className: "flex-1", style: { height }, children: /* @__PURE__ */ jsx11(
    Line,
    {
      data: {
        labels: sourceData.map((data) => data.label),
...
import { defaults as defaults4 } from "chart.js/auto";
import { Pie } from "react-chartjs-2";
import { jsx as jsx12 } from "react/jsx-runtime";
defaults4.maintainAspectRatio = false;
defaults4.responsive = true;
defaults4.plugins.title.display = true;
defaults4.plugins.title.align = "start";
defaults4.plugins.title.color = "black";
var sourcedata3 = [
  {
    label: "Ana",
    value: 32
...
function PieChart({
  ...
  return /* @__PURE__ */ jsx12("div", { className: "w-full", style: { height }, children: /* @__PURE__ */ jsx12(
    Pie,
    {
      data: {
        labels: sourceData.map((data) => data.label),
...
function Checkbox({
  ...
  const [checked, setChecked] = useState2(Boolean(value));
  const checkHandler = () => {
    if (disabled)
      return;
  ...
  return /* @__PURE__ */ jsx13(Fragment, { children: /* @__PURE__ */ jsxs5(
    "label",
    {
      htmlFor: "checkbox",
      className: clsx5("cursor-pointer", { "cursor-default": disabled }),
      children: [
        /* @__PURE__ */ jsx13(
          "button",
          {
            ...
            className: clsx5({ "cursor-default": disabled }),
            children: /* @__PURE__ */ jsxs5("div", { className: "flex gap-2 items-end justify-center", children: [
              !checked && /* @__PURE__ */ jsx13(
                BsSquare,
                {
                  className: clsx5("fill-current cursor-pointer", {
                    "text-red-600": error,
                    "text-gray-500": !error,
              ...
              /* @__PURE__ */ jsx13("p", { className: clsx5("text-sm", { "text-gray-400": disabled }), children: label })
            ] })
          }
        ),
        error && /* @__PURE__ */ jsx13("p", { className: "text-[10px] text-red-600 -mt-1", children: error })
      ]
    }
  ) });
}
...
function Input(props) {
  const [isVisibleContent, setIsVisibleContent] = useState3(false);
  const [isFocused, setIsFocused] = useState3(false);
  const inputType = props.isPassword ? isVisibleContent ? "text" : "password" : props.type ?? "text";
  return /* @__PURE__ */ jsxs6("div", { className: `flex flex-col w-${props.width ?? "full"}`, children: [
    /* @__PURE__ */ jsx14("p", { className: "text-sm font-medium", children: props.label }),
    /* @__PURE__ */ jsxs6(
      "div",
      {
        className: clsx6("border rounded py-[0.75px] relative border-gray-400", {
          "border-primary": isFocused,
          "border-red-600": props.error
        }),
        children: [
          /* @__PURE__ */ jsx14("div", { className: "flex items-center", children: /* @__PURE__ */ jsx14(
            "input",
            {
              value: props.value,
          ...
          props.isPassword && /* @__PURE__ */ jsx14(
            "div",
            {
              className: clsx6(
                `absolute inset-y-0 right-0 flex items-center pr-2`
              ),
              children: !isVisibleContent ? /* @__PURE__ */ jsx14(
                RiEyeOffLine,
                {
                  color: "#999",
    ...
    props.error && /* @__PURE__ */ jsx14("p", { className: "text-[10px] text-red-600", children: props.error })
  ] });
}
...
function InputMask(props) {
  ...
  return /* @__PURE__ */ jsxs7("div", { className: `flex flex-col w-${props.width ?? "full"}`, children: [
    /* @__PURE__ */ jsx15("p", { className: "text-sm font-medium", children: props.label }),
    /* @__PURE__ */ jsx15(
      "div",
      {
        className: clsx7("border border-gray-400 rounded py-[2.5px] relative", {
          "border-primary": isFocused,
          "border-red-600": props.error
        }),
        children: props.type === "money" ? /* @__PURE__ */ jsx15(
          CurrencyInput,
          {
            disabled: props.disabled,
    ...
    props.error && /* @__PURE__ */ jsx15("p", { className: "text-[10px] text-red-600", children: props.error })
  ] });
}
...
function Modal({
  ...
  return /* @__PURE__ */ jsx16(
    ...
    {
      center: true,
      closeIcon: /* @__PURE__ */ jsx16(MdClose, { size: 18 }),
      open: isOpen,
      onClose,
      styles: {
        modal: {
      ...
      children: /* @__PURE__ */ jsx16("div", { className: "py-1 px-1.5 min-w-14", children })
    }
  );
}
...
function Pagination({
  ...
  return /* @__PURE__ */ jsx17("div", { className: "flex justify-center mt-2", children: /* @__PURE__ */ jsxs8("ul", { className: "flex text-sm gap-1", children: [
    /* @__PURE__ */ jsx17(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx17(CgChevronLeft, { className: "text-lg text-primary" })
      }
    ),
    ...
    /* @__PURE__ */ jsx17(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx17(CgChevronRight, { className: "text-lg text-primary" })
      }
    )
  ] }) });
}
...
function Popover({
  ...
  return /* @__PURE__ */ jsxs9("div", { className: "relative", children: [
    /* @__PURE__ */ jsx18("button", { ref: buttonRef, onClick: togglePopover, className: "h-full flex", children: button }),
    isOpen && /* @__PURE__ */ jsx18(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsx18("div", { className: "flex justify-center items-center", children })
      }
    )
  ] });
}
...
function RadioButtonGroup({
  ...
  const [selectedOption, setSelectedOption] = useState5(value);
  ...
  return /* @__PURE__ */ jsxs10("div", { children: [
    /* @__PURE__ */ jsx19("p", { className: "text-sm mb-2", children: label }),
    options?.map((option, index) => /* @__PURE__ */ jsx19(
      RadioButton,
      {
        disabled,
        error,
    ...
    error && /* @__PURE__ */ jsx19("p", { className: "text-[10px] text-red-600 -mt-1", children: error })
  ] });
}
function RadioButton({
  ...
  return /* @__PURE__ */ jsx19("label", { htmlFor: String(value), className: "flex items-center gap-2 mb-1", children: /* @__PURE__ */ jsxs10(
    "button",
    {
      onClick: onChangeValue,
      value,
      className: clsx10("flex items-center gap-2 cursor-pointer", {
        "cursor-default": disabled
      }),
      children: [
        !checked && /* @__PURE__ */ jsx19(
          BsCircle,
          {
            className: clsx10("fill-current ", {
              "text-gray-500": !error,
              "text-red-600": error,
              "text-slate-300": disabled
            }),
        ...
        checked && /* @__PURE__ */ jsx19(
          BsCheckCircle,
          {
            className: clsx10("fill-current cursor-pointer", {
              "text-primary": !disabled,
              "cursor-default": disabled,
              "text-slate-300": disabled
            }),
        ...
        /* @__PURE__ */ jsx19("p", { className: clsx10("text-sm", { "text-gray-400": disabled }), children: label })
      ]
    }
  ) });
}
...
function RichText({
  ...
  return /* @__PURE__ */ jsxs11("div", { children: [
    /* @__PURE__ */ jsx20("p", { className: "text-sm font-medium", children: label }),
    /* @__PURE__ */ jsx20(
      "div",
      {
    ...
    error && /* @__PURE__ */ jsx20("p", { className: "text-[10px] text-red-600", children: error })
  ] });
}
var modules = {
  toolbar: {
...
function Select({
  ...
  return /* @__PURE__ */ jsxs12("div", { className: `w-${width ?? "full"}`, children: [
    /* @__PURE__ */ jsx21("p", { className: "text-sm font-medium", children: label }),
    /* @__PURE__ */ jsx21(
      SelectReact,
      {
        ...
        components: {
          ClearIndicator: (props) => /* @__PURE__ */ jsx21(
            "div",
            {
              ...props,
              onMouseDown: (e) => {
              ...
              children: /* @__PURE__ */ jsx21(IoClose, { size: 15, color: "#444" })
            }
          ),
          DropdownIndicator: () => /* @__PURE__ */ jsx21(BiChevronDown, { size: 18, color: "#777" })
        },
        styles: {
          placeholder: (base) => ({
            ...base,
    ...
    error && /* @__PURE__ */ jsx21("p", { className: "text-[10px] text-red-600", children: error })
  ] });
}
...
// lib/components/table/cell/index.tsx
import useForwardedRef4 from "@bedrock-layout/use-forwarded-ref";
import { jsx as jsx23 } from "react/jsx-runtime";
var TableCell = forwardRef5(
  ({ cell, state }, ref) => {
    const forwardedRef = useForwardedRef4(ref);
...
var TableCheckboxCell = forwardRef5(
  ({ cell, state }, ref) => {
    const forwardedRef = useForwardedRef4(ref);
    const { gridCellProps } = useTableCell({ node: cell }, state, forwardedRef);
    ...
    return /* @__PURE__ */ jsx23(
      "td",
      {
        ...
        ...gridCellProps,
        ref: forwardedRef,
        children: /* @__PURE__ */ jsx23(Checkbox2, { ...checkboxProps })
      }
    );
  }
);
var TableSelectAllCell = forwardRef5(
  ({ column, state }, ref) => {
    const forwardedRef = useForwardedRef4(ref);
    ...
    return /* @__PURE__ */ jsx23("th", { ...columnHeaderProps, ref: forwardedRef, children: isShowCheckbox ? /* @__PURE__ */ jsx23(VisuallyHidden, { children: checkboxProps["aria-label"] }) : /* @__PURE__ */ jsx23(Checkbox2, { ...checkboxProps }) });
  }
);
...
import useForwardedRef5 from "@bedrock-layout/use-forwarded-ref";
...
function TableRowGroup({
  ...
  return /* @__PURE__ */ jsx24(Element, { ...mergeProps2(rowGroupProps, props), children });
}
var TableHeaderRow = forwardRef6(
  ({ state, children, item }, ref) => {
    const forwardedRef = useForwardedRef5(ref);
    const { rowProps } = useTableHeaderRow({ node: item }, state, forwardedRef);
    return /* @__PURE__ */ jsx24("tr", { ...rowProps, ref: forwardedRef, className: "tr-header", children });
  }
);
var TableColumnHeader = forwardRef6(
  ({ state, column }, ref) => {
    const forwardedRef = useForwardedRef5(ref);
    ...
    return /* @__PURE__ */ jsx24(
      ...
      {
        ref: forwardedRef,
        ...mergeProps2(columnHeaderProps, focusProps),
        className: clsx12("th-header", {
...
import { mergeProps as mergeProps3, useFocusRing as useFocusRing3, useTableRow } from "react-aria";
import clsx13 from "clsx";
import useForwardedRef6 from "@bedrock-layout/use-forwarded-ref";
import { forwardRef as forwardRef7 } from "react";
import { jsx as jsx25 } from "react/jsx-runtime";
var TableRow = forwardRef7(
  ({ item, state, children }, ref) => {
    const forwardedRef = useForwardedRef6(ref);
    ...
    return /* @__PURE__ */ jsx25(
      ...
      {
        ref: forwardedRef,
        ...mergeProps3(rowProps, focusProps),
        className: clsx13("tr-row", {
          "--selected": isSelected,
          "--pressed": isPressed,
          "--outlined": isFocusVisible,
          "--disabled": isDisabled
...
// lib/components/table/index.tsx
import useForwardedRef7 from "@bedrock-layout/use-forwarded-ref";
import { jsx as jsx26, jsxs as jsxs13 } from "react/jsx-runtime";
var CustomTable = forwardRef8(
  (props, ref) => {
    const forwardedRef = useForwardedRef7(ref);
    ...
    return /* @__PURE__ */ jsxs13("table", { ...gridProps, ref: forwardedRef, className: "custom-table", children: [
      /* @__PURE__ */ jsx26(TableRowGroup, { type: "thead", children: collection.headerRows.map((headerRow) => /* @__PURE__ */ jsx26(TableHeaderRow, { item: headerRow, state, children: [...headerRow.childNodes].map(
        (column) => column.props.isSelectionCell ? /* @__PURE__ */ jsx26(
          TableSelectAllCell,
          {
            column,
            state
      ...
      /* @__PURE__ */ jsx26(TableRowGroup, { type: "tbody", children: [...collection.body.childNodes].map((row) => /* @__PURE__ */ jsx26(TableRow, { item: row, state, children: [...row.childNodes].map(
        (cell) => cell.props.isSelectionCell ? /* @__PURE__ */ jsx26(TableCheckboxCell, { cell, state }, cell.key) : /* @__PURE__ */ jsx26(TableCell, { cell, state }, cell.key)
      ) }, row.key)) })
    ] });
  }
);
function Table({
  ...
  return /* @__PURE__ */ jsx26("div", { className: "safearea-table", children: /* @__PURE__ */ jsxs13(
    CustomTable,
    {
      "aria-label": "Tabela",
      selectionMode: mode,
      ...
      onRowAction,
      children: [
        /* @__PURE__ */ jsx26(TableHeader, { children: columns.map((column) => /* @__PURE__ */ jsx26(Column, { children: column.elem }, column.key)) }),
        /* @__PURE__ */ jsx26(TableBody, { children: rows.map(({ key, items }) => /* @__PURE__ */ jsx26(Row, { children: items.map((item) => /* @__PURE__ */ jsx26(Cell, { children: item.elem }, item.key)) }, key)) })
      ]
    }
  ) });
}
...
function Tabs({ tabs }) {
  const [tabSelected, setTabSelected] = useState7(0);
  const handleTabClick = (index) => {
    setTabSelected(index);
  };
  return /* @__PURE__ */ jsxs14("div", { children: [
    /* @__PURE__ */ jsx27("div", { className: "flex border-b border-gray-200 mb-4", children: tabs.map((tab, index) => /* @__PURE__ */ jsx27(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx27("span", { children: tab.title })
      },
      index
    )) }),
    /* @__PURE__ */ jsx27("div", { children: /* @__PURE__ */ jsx27("span", { children: tabs[tabSelected].content }) })
  ] });
}

// lib/components/text/index.tsx
import { forwardRef as forwardRef9 } from "react";
import useForwardedRef8 from "@bedrock-layout/use-forwarded-ref";
import clsx14 from "clsx";
import { jsx as jsx28 } from "react/jsx-runtime";
var Text = forwardRef9(
  ({
    as: Tag = "span",
    size = "sm",
    variant,
    ...
    const forwardedRef = useForwardedRef8(ref);
    return /* @__PURE__ */ jsx28(
      Tag,
      {
        ...
        style: { fontFamily: "Plus Jakarta Sans" },
        ref: forwardedRef,
        className: clsx14(className, "text", {
          "--block": mode === "block",
          "--unset": mode === "unset",
          "--primary": variant === "primary",
          "--secondary": variant === "secondary",
...
function Toast({ title, message }, renderIcon, variant, color) {
  const CustomToast = () => /* @__PURE__ */ jsxs15("div", { className: "wrapper-toast", children: [
    /* @__PURE__ */ jsx29("div", { children: renderIcon }),
    /* @__PURE__ */ jsxs15("div", { children: [
      /* @__PURE__ */ jsx29(Text, { as: "p", variant, className: "font-bold", size: "md", children: title }),
      /* @__PURE__ */ jsx29(Text, { as: "p", size: "xs", variant: "secondary", children: message })
    ] })
  ] });
  toast2(/* @__PURE__ */ jsx29(CustomToast, {}), {
    autoClose: 3e3,
    hideProgressBar: true,
    style: {
      background: color
...
var showToast = {
  error: (message) => {
    Toast(
      { title: "Erro", message },
      /* @__PURE__ */ jsx29(BiErrorCircle, { color: "#e74c3c", size: 24 }),
      "danger",
      "#FEF2F2"
    );
  },
  success: (message) => {
    Toast(
      ...
      /* @__PURE__ */ jsx29(BiCheckCircle, { color: "#27ae60", size: 24 }),
      "success",
      "#F0FDF4"
    );
  },
  warning: (message) => {
    Toast(
      ...
      /* @__PURE__ */ jsx29(PiWarningCircle, { color: "#e67e22", size: 24 }),
      "warning",
      "#FFF7ED"
    );
  }
...
function Wizard({ steps }) {
  ...
  return /* @__PURE__ */ jsxs16("div", { className: "flex flex-col", children: [
    /* @__PURE__ */ jsx30("div", { className: "mb-4 px-6 py-3 flex items-center justify-center", children: steps.map((step, index) => /* @__PURE__ */ jsxs16(React3.Fragment, { children: [
      /* @__PURE__ */ jsx30("div", { className: "flex items-center flex-col text-sm", children: currentStep === index ? /* @__PURE__ */ jsx30("div", { className: "border p-2 rounded-full bg-primary", children: /* @__PURE__ */ jsx30("p", { className: "text-white text-sm", children: step.icon }) }) : /* @__PURE__ */ jsx30("div", { className: "border p-2 rounded-full", children: /* @__PURE__ */ jsx30("p", { className: "text-sm", children: step.icon }) }) }),
      index !== totalSteps - 1 && /* @__PURE__ */ jsx30("div", { className: "w-[20%] h-[1px] bg-slate-300 mx-2" })
    ] }, index)) }),
    /* @__PURE__ */ jsx30("div", { className: "flex-1 text-sm text-center", children: steps[currentStep].component }),
    /* @__PURE__ */ jsxs16("div", { className: "flex justify-between py-4 px-6 ", children: [
      /* @__PURE__ */ jsx30("div", { children: currentStep > 0 && /* @__PURE__ */ jsx30(
        Button,
        {
          onClick: handlePrevious,
          text: "Anterior",
          iconLeft: /* @__PURE__ */ jsx30(BiChevronLeft, { size: 18 })
        }
      ) }),
      /* @__PURE__ */ jsx30("div", { children: currentStep < totalSteps - 1 ? /* @__PURE__ */ jsx30(
        Button,
        {
          onClick: handleNext,
          text: "Pr\xF3ximo",
          iconRight: /* @__PURE__ */ jsx30(BiChevronRight, { size: 18 })
        }
      ) : /* @__PURE__ */ jsx30(Button, { onClick: handleReset, text: "Resetar" }) })
    ] })
  ] });
}
...
function PopoverProfile({
  ...
  return /* @__PURE__ */ jsxs17("div", { className: "w-full", children: [
    /* @__PURE__ */ jsxs17("div", { className: "flex gap-2 border-b pb-2 mb-2", children: [
      /* @__PURE__ */ jsx31(
        "img",
        {
      ...
      /* @__PURE__ */ jsxs17("div", { className: "flex flex-col", children: [
        /* @__PURE__ */ jsx31("span", { className: "font-semibold text-sm line-clamp-1 ", children: userLoggedData.name }),
        /* @__PURE__ */ jsx31("span", { className: "font-light text-[0.65rem] ", children: userLoggedData.description })
      ] })
    ] }),
    /* @__PURE__ */ jsxs17("ul", { children: [
      menuItems?.map((item, index) => /* @__PURE__ */ jsxs17(
        "li",
        {
          className: "flex items-center gap-2 p-1 rounded hover:bg-slate-100 transition cursor-pointer",
          children: [
            item.icon,
            /* @__PURE__ */ jsx31("span", { className: "text-sm ", children: item.title })
          ]
        },
        index
      )),
      /* @__PURE__ */ jsx31("div", { className: "border-t my-2" }),
      /* @__PURE__ */ jsxs17(
        "li",
        {
          ...
          children: [
            /* @__PURE__ */ jsx31(LuLogOut, { size: 14 }),
            /* @__PURE__ */ jsx31("span", { className: "text-sm ", children: "Sair" })
          ]
        }
      )
    ] })
...
function DashboardLayout({
  ...
  const [isShowPopoverProfile, setIsShowPopoverProfile] = useState9(false);
  const isSmallScreen = useMediaQuery({ query: "(max-width: 768px)" });
  const [open, setOpen] = useState9(
    startSidebarOpened && !isSmallScreen ? true : false
  );
  const sidebarRef = useRef2();
  const [dropdownActive, setDropdownActive] = useState9({
    group: null,
    itemGroup: null
  });
  useEffect2(() => {
  ...
  return /* @__PURE__ */ jsxs18("div", { className: "flex", children: [
    /* @__PURE__ */ jsxs18("div", { children: [
      ...
      /* @__PURE__ */ jsxs18(
        motion2.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs18("div", { className: "flex items-center gap-2 font-medium py-3 mx-5", children: [
              /* @__PURE__ */ jsx32("img", { src: logo_temp_default, width: 12, alt: "", className: "w-[12px]" }),
              (open || isSmallScreen) && /* @__PURE__ */ jsx32("span", { className: "text-[1.rem] whitespace-pre font-semibold", children: "Dashboard" })
            ] }),
            menuItems?.map((group, indexGroup) => /* @__PURE__ */ jsxs18("div", { className: "px-3", children: [
              (open || isSmallScreen) && /* @__PURE__ */ jsx32("small", { className: "inline-block px-1 font-medium text-slate-400 text-[12px]", children: group.group_name }),
              group.items.map((item, indexItem) => /* @__PURE__ */ jsxs18("div", { children: [
                /* @__PURE__ */ jsxs18(
                  "li",
                  {
                    ...
                    children: [
                      item.icon,
                      (open || isSmallScreen) && /* @__PURE__ */ jsx32("span", { className: "text-sm font-medium text-black w-full select-none", children: item.title }),
                      (open || isSmallScreen) && item.dropdown && item.dropdown?.length && /* @__PURE__ */ jsx32(FiChevronDown, { className: "mr-1", size: 19 })
                    ]
                  },
                  indexItem
                ),
                (open || isSmallScreen) && dropdownActive.group === indexGroup && dropdownActive.itemGroup === indexItem && /* @__PURE__ */ jsx32(
                  motion2.div,
                  {
                    ...
                    children: item.dropdown?.map((dropdown_item, dropdownIndex) => /* @__PURE__ */ jsx32("div", { className: "flex", children: /* @__PURE__ */ jsxs18(
                      "button",
                      {
                        onClick: () => {
                        ...
                        children: [
                          /* @__PURE__ */ jsx32("span", { className: "text-[6px]", children: "\u25CB" }),
                          dropdown_item.title
                        ]
                      }
                    ) }, dropdownIndex))
    ...
    /* @__PURE__ */ jsxs18("div", { className: "h-screen w-screen flex flex-col flex-1", children: [
      /* @__PURE__ */ jsxs18("div", { className: "bg-white py-4 pl-2 pr-6 ml-[1px] flex items-center gap-2 h-12 justify-between border-b", children: [
        /* @__PURE__ */ jsxs18("div", { className: "flex gap-2 flex-1", children: [
          /* @__PURE__ */ jsx32(
            "div",
            {
              className: "m-1 md:hidden cursor-pointer",
              onClick: () => setOpen(true),
              children: /* @__PURE__ */ jsx32(MdMenu, { size: 25 })
            }
          ),
          /* @__PURE__ */ jsx32("div", { className: "flex", children: /* @__PURE__ */ jsx32(
            "div",
            {
              onClick: () => {
                setOpen(!open);
              ...
              children: /* @__PURE__ */ jsx32(
                motion2.div,
                {
                  ...
                  children: /* @__PURE__ */ jsx32(LuMenu, { size: 20 })
                }
              )
            }
          ) })
        ] }),
        /* @__PURE__ */ jsx32("div", { className: "flex gap-2", children: /* @__PURE__ */ jsx32(
          Popover,
          {
...
function ProviderUiComponents({ children }) {
  return /* @__PURE__ */ jsxs19(Fragment2, { children: [
    children,
    /* @__PURE__ */ jsx33(ToastContainer2, {})
  ] });
}
